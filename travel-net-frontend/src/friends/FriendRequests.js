...
const FriendRequests = (props) => {
  ...
  const requestList = props.friendRequests.map(request => <li key={request.id}>{request.username} <a onClick={() => props.positiveResponseFriendRequest(props.currentUser, request)}>Add Friend</a></li>)
  return(
    <div>
